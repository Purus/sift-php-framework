...
//			var bodyPos = $target.offsetParent().offset();
      ...
      var offsetTop = markerOffset.top >= 0 ? ('+' + markerOffset.top) : (markerOffset.top);
      var offsetLeft = markerOffset.left >= 0 ? ('+' + markerOffset.left) : (markerOffset.left);
      
			this.$dndMarker
				.show()
				.position({
          my: "left" + offsetLeft + ' top' + offsetTop,
					at: "left top",
					of: $target
				});
