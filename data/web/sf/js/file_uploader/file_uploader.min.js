...
h+'" value="'+l.id+'" />').data("uid",f.uid).insertAfter(this.$element)}}else c=!0,d="abort"==a.errorThrown?this.options.messages.aborted:"undefined"!==typeof a.jqXHR.responseJSON&&"undefined"!==typeof a.jqXHR.responseJSON.files[a.index]&&a.jqXHR.responseJSON.files[a.index].error?a.jqXHR.responseJSON.files[a.index].error:this.options.messages.error;g.removeClass("in-progress").addClass("success");g.find(".percentage").hide().remove();g.find(".bar").css("width","100%");g.find(".file-uploader-state").removeClass("in-progress").addClass(c?
"error":"success").html(d);this.enableSubmits()}};b.fn.fileUploader=function(e){return this.each(function(){var a=b(this),c=a.data("fileUploader"),d="object"===typeof e&&e;c||a.data("fileUploader",c=new h(this,d));if("string"===typeof e)c[e]()})};b.fn.fileUploader.defaults={messages:{uploadedBytes:"Uploaded bytes exceed file size",maxNumberOfFiles:"Maximum number of files exceeded",acceptFileTypes:"File type not allowed",maxFileSize:"File is too large",minFileSize:"File is too small",browseFiles:"Browse files...",
cancel:"cancel",notAvailable:"n/a",error:"Error occurred.",uploaded:"Successfully uploaded.",aborted:"Upload aborted.",uploadStarted:"Uploading in progress, please wait...",uploadInQueue:"File queued for upload."},buttonText:!1,sequentialUploads:!0,forceIframeTransport:!1,iframeRedirect:"",iframeRedirectParameterName:"_redirect",formData:!1,maxNumberOfFiles:void 0,maxFileSize:2E8,maxChunkSize:0,acceptFileTypes:void 0,inputName:!1,dropZone:!1,queue:!1,url:"",itemTemplate:'<div class="file-uploader-item file-uploader-type-{{type}}">\n    <div class="file-uploader-info"><span class="file-uploader-filename">{{file}}</span> {{size}}</div>\n<span class="percentage"></span>\n    <a href="#" class="file-uploader-cancel"><strong> &times;</strong> {{cancel}}</a>\n    <div class="file-uploader-state"></div>\n    <div class="file-uploader-progress"><div class="bar" style="width: 0%;"></div></div>\n    </div>'};
