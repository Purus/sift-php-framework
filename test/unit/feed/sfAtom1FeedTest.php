...
$enclosure = new sfFeedEnclosure($enclosureParams);

$date = new DateTime("2012-07-05 16:43:21", new DateTimeZone('UTC'));
$date = $date->format('U');
...
$feed = new sfAtom1Feed($feedParams);

$feedItem = new sfFeedItem($itemParams);
$feed->addItem($feedItem);
$feedItem2 = new sfFeedItem($item2Params);
$feed->addItem($feedItem2);

$feedImage = new sfFeedImage($image_params);
