...
$m = new sfClassManipulator($source);
$m->appendMethod('getFoobar', array('$f', '$b'), 'return null;', array('public', 'static'));

$file = sys_get_temp_dir().'/sf_tmp.php';
$m->setFile($file);
$m->save();
$t->is(file_get_contents($file), '<?php
...
class Foo
{
  ...
  public static function getFoobar($f, $b)
  {
    return null;
  }
}', 'appendMethod() works ok');
