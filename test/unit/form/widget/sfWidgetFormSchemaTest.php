...
<tr>
  <th><label style="padding: 5px" for="id_article_first_name" id="id_article_first_name_label">First name</label></th>
...
<tr>
  <th><label style="padding: 5px" for="id_article_last_name" id="id_article_last_name_label">Last name</label></th>
...
<tr>
  ...
  <td>
    <table>
      <tr>
        <th><label for="w4_w3" id="w4_w3_label">W3</label></th>
