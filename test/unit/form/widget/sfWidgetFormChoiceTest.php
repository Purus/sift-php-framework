...
$w->setOption('expanded', true);
$t->like($w->render('foo'), '/class="checkbox-list">/', '->render() uses a checkbox list when expanded and multiple are true');
$w->setOption('multiple', false);
$t->like($w->render('foo'), '/class="radio-list">/', '->render() uses a checkbox list when expanded is true and multiple is false');
