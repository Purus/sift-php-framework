...
$output = <<< EOF
<ul class="radio-list"><li><input name="myname" type="radio" value="0" id="myname_0" checked="checked" /> <label for="myname_0">bar</label></li>
...
$w = new sfWidgetFormSelectRadio(array('choices' => array('0' => 'bar', '1' => 'foo')));
$output = <<< EOF
<ul class="radio-list"><li><input name="myname" type="radio" value="0" id="myname_0" /> <label for="myname_0">bar</label></li>
...
$output = <<<EOF
foo <ul class="radio-list"><li><input name="foo" type="radio" value="foo" id="foo_foo" checked="checked" /> <label for="foo_foo">bar</label></li>
<li><input name="foo" type="radio" value="bar" id="foo_bar" /> <label for="foo_bar">foo</label></li></ul>
bar <ul class="radio-list"><li><input name="foo" type="radio" value="foobar" id="foo_foobar" /> <label for="foo_foobar">barfoo</label></li></ul>
EOF;
...
$t->is($w->render('foo'), '<ul class="radio-list"><li><input name="foo" type="radio" value="0" id="foo_0" /> <label for="foo_0">&lt;b&gt;Hello world&lt;/b&gt;</label></li></ul>', '->render() escapes the choices');
...
$t->diag('->render()');
$w = new sfWidgetFormSelectRadio(array('choices' => array('foo' => 'bar', 'foobar' => 'foo'), 'separator' => ''));
$output = '<ul role="list" class="radio-list">'.
'<li role="listitem"><input name="foo" type="radio" value="foo" id="foo_foo" aria-labelledby="foo_foo_label" /> <label for="foo_foo" id="foo_foo_label">bar</label></li>'.
'<li role="listitem"><input name="foo" type="radio" value="foobar" id="foo_foobar" checked="checked" aria-labelledby="foo_foobar_label" /> <label for="foo_foobar" id="foo_foobar_label">foo</label></li>'.
'</ul>';
$t->is($w->render('foo', 'foobar'), $output, '->render() renders a radio tag with the value checked');

// regression for ticket #3528
$onChange = '<ul role="list" class="radio-list">'.
'<li role="listitem"><input name="foo" type="radio" value="foo" id="foo_foo" onChange="alert(42)" aria-labelledby="foo_foo_label" />'.
' <label for="foo_foo" id="foo_foo_label">bar</label></li>'.
'<li role="listitem"><input name="foo" type="radio" value="foobar" id="foo_foobar" checked="checked" onChange="alert(42)" aria-labelledby="foo_foobar_label" />'.
...
$w = new sfWidgetFormSelectRadio(array('choices' => array('0' => 'bar', '1' => 'foo')));
$output = <<< EOF
<ul role="list" class="radio-list"><li role="listitem"><input name="myname" type="radio" value="0" id="myname_0" checked="checked" aria-labelledby="myname_0_label" /> <label for="myname_0" id="myname_0_label">bar</label></li>
<li role="listitem"><input name="myname" type="radio" value="1" id="myname_1" aria-labelledby="myname_1_label" /> <label for="myname_1" id="myname_1_label">foo</label></li></ul>
EOF;
$t->is($w->render('myname', false), fix_linebreaks($output), '->render() considers false to be an integer 0');

$w = new sfWidgetFormSelectRadio(array('choices' => array('0' => 'bar', '1' => 'foo')));
$output = <<< EOF
<ul role="list" class="radio-list"><li role="listitem"><input name="myname" type="radio" value="0" id="myname_0" aria-labelledby="myname_0_label" /> <label for="myname_0" id="myname_0_label">bar</label></li>
<li role="listitem"><input name="myname" type="radio" value="1" id="myname_1" checked="checked" aria-labelledby="myname_1_label" /> <label for="myname_1" id="myname_1_label">foo</label></li></ul>
EOF;
$t->is($w->render('myname', true), fix_linebreaks($output), '->render() considers true to be an integer 1');
...
$w = new sfWidgetFormSelectRadio(array('choices' => array('foo' => array('foo' => 'bar', 'bar' => 'foo'), 'bar' => array('foobar' => 'barfoo'))));
$output = <<<EOF
foo <ul role="list" class="radio-list"><li role="listitem"><input name="foo" type="radio" value="foo" id="foo_foo" checked="checked" aria-labelledby="foo_foo_label" /> <label for="foo_foo" id="foo_foo_label">bar</label></li>
<li role="listitem"><input name="foo" type="radio" value="bar" id="foo_bar" aria-labelledby="foo_bar_label" /> <label for="foo_bar" id="foo_bar_label">foo</label></li></ul>
bar <ul role="list" class="radio-list"><li role="listitem"><input name="foo" type="radio" value="foobar" id="foo_foobar" aria-labelledby="foo_foobar_label" /> <label for="foo_foobar" id="foo_foobar_label">barfoo</label></li></ul>
EOF;
$t->is($w->render('foo', 'foo'), fix_linebreaks($output), '->render() has support for groups');
...
$w->setParent($ws);
$output = '<ul role="list" class="radio-list">'.
'<li role="listitem"><input name="foo" type="radio" value="foo" id="foo_foo" aria-labelledby="foo_foo_label" /> <label for="foo_foo" id="foo_foo_label">translation[bar]</label></li>'.
'<li role="listitem"><input name="foo" type="radio" value="foobar" id="foo_foobar" aria-labelledby="foo_foobar_label" /> <label for="foo_foobar" id="foo_foobar_label">translation[foo]</label></li>'.
'</ul>';
$t->is($w->render('foo'), $output, '->render() translates the options');
...
$w = new sfWidgetFormSelectRadio(array('choices' => array('<b>Hello world</b>')));
$t->is($w->render('foo'), '<ul role="list" class="radio-list"><li role="listitem"><input name="foo" type="radio" value="0" id="foo_0" aria-labelledby="foo_0_label" /> <label for="foo_0" id="foo_0_label">&lt;b&gt;Hello world&lt;/b&gt;</label></li></ul>', '->render() escapes the choices');
