...
$t->diag('sfMailer unit tests are in progress!');
$t->diag('NOT DONE! WORK ON IT!');
...
//try
//{
//  new myMailer(array('transport' => 'foo'));
//
...
//try
//{
//  $mailer = new myMailer(array('delivery_strategy' => 'spool'));
//
...
//}
//
//$mailer = new myMailer(array('delivery_strategy' => 'spool', 'spool_class' => 'TestSpool'));
...
//try
//{
//  $mailer = new myMailer(array('delivery_strategy' => 'single_address'));
//
...
//// ->compose()
//$t->diag('->compose()');
//$mailer = new myMailer(array('delivery_strategy' => 'none'));
...
//$mailer = new myMailer(array('logging' => true, 'delivery_strategy' => 'none'));
