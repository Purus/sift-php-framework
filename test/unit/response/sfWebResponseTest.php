...
$t->is($response->getJavascripts(), array('test' => array(), 'foo' => array()), '->getJavascripts() returns all current registered javascripts');
$t->is($response->getJavascripts('first'), array('first' => array()), '->getJavascripts() takes a position as its first argument');
$t->is($response->getJavascripts('last'), array('last' => array()), '->getJavascripts() takes a position as its first argument');
