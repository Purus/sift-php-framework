...
$user->culture = 'en';
$time = time();
$t->is(format_date($time, 'f'), date('j F Y H:i:s', $time).' '.date('T', $time), 'format_date() takes a format string as its second argument');

$user->culture = 'fr';
$t->is(format_date($time, 'f', 'en'), date('j F Y H:i:s', $time).' '.date('T', $time), 'format_date() takes a culture as its third argument');
