...
$t->is($v->getOptions(), array('required' => true, 'trim' => false, 'empty_value' => '', 'min_length' => 2, 'max_length' => null, 'sanitize' => false), '->getOptions() returns an array of options from the embedded validator');
