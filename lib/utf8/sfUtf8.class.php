...
class sfUtf8
{
    ...
    const clean = 'sfUtf8::clean';
    const cmp = 'sfUtf8::cmp';
    const explode = 'sfUtf8::explode';
    const icmp = 'sfUtf8::icmp';
    const inatcmp = 'sfUtf8::inatcmp';
    const ipos = 'sfUtf8::ipos';
    const ireplace = 'sfUtf8::ireplace';
    const irpos = 'sfUtf8::irpos';
    const istr = 'sfUtf8::istr';
    const len = 'sfUtf8::len';
    const lower = 'sfUtf8::lower';
    const ltrim = 'sfUtf8::ltrim';
    const natcmp = 'sfUtf8::natcmp';
    const ord = 'sfUtf8::ord';
    const pad = 'sfUtf8::pad';
    const pos = 'sfUtf8::pos';
    const replace = 'sfUtf8::replace';
    const reset = 'sfUtf8::reset';
    const rev = 'sfUtf8::rev';
    const rpos = 'sfUtf8::rpos';
    const rtrim = 'sfUtf8::rtrim';
    const str = 'sfUtf8::str';
    const sub = 'sfUtf8::sub';
    const trim = 'sfUtf8::trim';
    const ucfirst = 'sfUtf8::ucfirst';
    const ucwords = 'sfUtf8::ucwords';
    const upper = 'sfUtf8::upper';
    const wordwrap = 'sfUtf8::wordwrap';
    const convertToUtf8 = 'sfUtf8::convertToUtf8';
    const subReplace = 'sfUtf8::subReplace';
     ...
     * @var array
     */
    private static $mb_lower_to_upper_fix
        = array(
            'ɘ' => 'Ǝ',
            'ǲ' => 'Ǳ',
            'ა' => 'Ⴀ',
     ...
     * @var array
     */
    private static $mb_upper_to_lower_fix
        = array(
            'ǝ' => 'ɘ',
            'ǅ' => 'ǆ',
            'ǈ' => 'ǉ',
    ...
    /**
     * Tries to convert given text to UTF-8
     *
     * @param string  $string
    ...
    public static function ord($character)
    {
        ...
        switch (strlen($character)) {
            ...
            case 2:
                if ($b[0] < 0xC2 || $b[0] > 0xDF || $b[1] < 0x80 || $b[1] > 0xBF) {
                    $invalid = true;
                    break;
                }
            ...
            case 3:
                if ($b[0] < 0xE0 || $b[0] > 0xEF || $b[1] < 0x80 || $b[1] > 0xBF || $b[2] < 0x80 || $b[2] > 0xBF) {
                    $invalid = true;
                    break;
                }
            ...
            case 4:
                if ($b[0] < 0xF0 || $b[0] > 0xF4 || $b[1] < 0x80 || $b[1] > 0xBF || $b[2] < 0x80 || $b[2] > 0xBF
                    || $b[3] < 0x80
                    || $b[3] > 0xBF
                ) {
                    $invalid = true;
    ...
    public static function subReplace($string, $replacement, $start = null, $length = null)
    {
        ...
        return self::sub($string, 0, $start) . $replacement . self::sub(
            $string,
            $start + $length,
