...
class sfValidatorSchemaTimeInterval extends sfValidatorSchema
{
    ...
    protected function doClean($values)
    {
        ...
        $this->dateStart = isset($values[$this->getOption('date_start_field')]) ? strtotime(
            $values[$this->getOption('date_start_field')]
        ) : null;
        $this->dateEnd = isset($values[$this->getOption('date_end_field')]) ? strtotime(
            $values[$this->getOption('date_end_field')]
        ) : null;
        ...
        if ($this->getOption('disallow_future_dates')) {
            if (!is_null($this->dateStart) && $this->dateStart > time()) {
                ...
                if (!is_null($this->dateEnd) && $this->dateEnd > time()) {
