...
class sfValidatorErrorSchema extends sfValidatorError implements ArrayAccess, Iterator, Countable
{
    ...
    protected function updateCode()
    {
        $this->code = implode(
            ...
            array_merge(
                ...
                array_map(
                    create_function('$n,$e', 'return $n.\' [\'.$e->getCode().\']\';'),
    ...
    protected function updateMessage()
    {
        $this->message = implode(
            ...
            array_merge(
                ...
                array_map(
                    create_function('$n,$e', 'return $n.\' [\'.$e->getMessage().\']\';'),
                    array_keys($this->namedErrors),
                    array_values($this->namedErrors)
                )
            )
    ...
    {
        list($this->validator, $this->arguments, $this->code, $this->message, $this->errors, $this->globalErrors,
            $this->namedErrors)
