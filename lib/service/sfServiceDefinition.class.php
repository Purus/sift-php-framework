...
class sfServiceDefinition
{
  ...
  /**
   * Creates tnhe definition from array
   * 
   * @param array $array
  ...
  public static function createFromArray(array $array)
  {
    ...
    {
      throw new InvalidArgumentException('Missing "class" key in the service definition');
    }
    
    $definition = new self($array['class'], (isset($array['arguments']) ? $array['arguments'] : array()));
