...
class sfPDOSessionStorage extends sfSessionStorage
{
    ...
    public function sessionDestroy($id)
    {
        ...
        try {
            ...
            throw new sfDatabaseException(sprintf(
    ...
    public function sessionOpen($path, $name)
    {
        ...
        if ($this->db == null || !$this->db instanceof PDO) {
            throw new sfDatabaseException(
                sprintf(
                    'PDO dabatase connection "%s" doesn\'t exist. Unable to open session.',
                    $this->getOption('database')
                ), sfDatabaseException::SESSION_ERROR);
        }
    ...
    public function sessionWrite($id, $data)
    {
        ...
        $sql = 'UPDATE ' . $db_table . ' SET ' . $db_data_col . ' = ?, ' . $db_time_col . ' = ' . time() . ' WHERE '
            . $db_id_col . '= ?';
    ...
    {
        // commit transaction
        if ($this->getOption('use_transaction') && $this->transactionStarted) {
