...
class sfMath
{
    ...
    {
        return is_null($precision)
            ? bccomp($left_operand, $right_operand)
            : bccomp(
                $left_operand,
                $right_operand,
                $precision
    ...
    {
        return is_null($precision)
            ? bcdiv($left_operand, $right_operand)
            : bcdiv(
                $left_operand,
                $right_operand,
                $precision
    ...
    {
        return is_null($precision)
            ? bcmul($left_operand, $right_operand)
            : bcmul(
                $left_operand,
                $right_operand,
                $precision
    ...
    {
        return is_null($precision)
            ? bcpow($left_operand, $right_operand)
            : bcpow(
                $left_operand,
                $right_operand,
                $precision
    ...
    {
        return is_null($precision)
            ? bcpowmod($left_operand, $right_operand, $modulus)
            : bcpowmod(
                $left_operand,
                $right_operand,
                $modulus,
    ...
    {
        return is_null($precision)
            ? bcsub($left_operand, $right_operand)
            : bcsub(
                $left_operand,
                $right_operand,
                $precision
