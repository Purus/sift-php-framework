...
/**
 * sfTime class. A library for manipulating dates.
 *
 * @package Sift
 * @subpackage date
...
class sfTime {
   ...
   * @see firstDayOfWeek
   */
  public static function finalDayOfWeek($ts = null, $firstDay = null)
  {
    return sfTime::subtractDay(sfTime::firstDayOfWeek(sfTime::addWeek($ts), $firstDay));
  }
