    ...
    protected function execute($arguments = array(), $options = array())
    {
        ...
        if (is_dir($moduleDir)) {
            throw new sfCliCommandException(sprintf(
                'The module "%s" already exists in the "%s" plugin.',
                $moduleDir,
                $plugin
            ));
        }
        ...
        $this->getFilesystem()->rename(
            $moduleDir . '/lib/BaseActions.class.php',
            $moduleDir . '/lib/Base' . $module . 'Actions.class.php'
        );
        ...
        if (file_exists($testDir . '/fixtures/project/app')) {
            ...
            $this->getFilesystem()->copy(
                ...
                $testDir . '/functional/' . $module . 'ActionsTest.php'
            );
