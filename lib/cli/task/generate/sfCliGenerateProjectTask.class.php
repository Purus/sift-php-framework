    ...
    protected function configure()
    {
        $this->addArguments(
            array(
                ...
                new sfCliCommandArgument('webmaster_email', sfCliCommandArgument::REQUIRED, 'The webmaster email'),
...
You have to specify the [webmaster email|COMMENT] as second argument. This is used in
500 error pages. This can be modified later in the project app.yml configuration file.

You can optionally include a third [author|COMMENT] argument to specify what name to
use as author when framework generates new modules and other generated stuff:

  [{$scriptName} generate:project blog jack@my-project.com "Jack Doe" |INFO]
EOF;
    }
    ...
    protected function execute($arguments = array(), $options = array())
    {
        ...
        $this->tokens = array(
            ...
            'WEBMASTER_EMAIL'  => $this->arguments['webmaster_email'],
