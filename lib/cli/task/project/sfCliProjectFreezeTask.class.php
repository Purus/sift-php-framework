...
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    $this->logSection($this->getFullName(), sprintf('Freezing project to %s %s',             
    ...
    file_put_contents($this->environment->get('sf_config_dir').'/config.php.bak', sprintf(
      '%s#%s', $this->environment->get('sf_sift_lib_dir'), $this->environment->get('sf_sift_data_dir')
    ));
