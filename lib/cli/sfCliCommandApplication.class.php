...
abstract class sfCliCommandApplication
{
    ...
    public function __construct(
        ...
        sfCliFormatter $formatter = null,
        sfConsoleLogger $logger = null
    ) {
        ...
        if (null !== $this->currentTask && $e instanceof sfCliCommandArgumentsException) {
            fwrite(
                ...
                $this->formatter->format(
                    sprintf($this->currentTask->getSynopsis(), $this->getScriptName()),
                    'INFO',
                    STDERR
                ) . "\n"
            );
