...
class sfCliCommandManager
{
     ...
     * Constructor.
     *
     * @param sfCliCommandArgumentSet $argumentSet A sfCommandArgumentSet object
     * @param sfCliCommandOptionSet   $optionSet   A setOptionSet object
     */
     ...
     *
     * @param sfCliCommandArgumentSet $argumentSet A sfCliCommandArgumentSet object
     */
    public function setArgumentSet(sfCliCommandArgumentSet $argumentSet)
    {
     ...
     *
     * @return sfCliCommandArgumentSet A sfCliCommandArgumentSet object
     */
     ...
     * Sets the option set.
     *
     * @param sfCliCommandOptionSet $optionSet A sfCliCommandOptionSet object
     */
    public function setOptionSet(sfCliCommandOptionSet $optionSet)
    {
     ...
     * Gets the option set.
     *
     * @return sfCliCommandOptionSet A sfCliCommandOptionSet object
     */
