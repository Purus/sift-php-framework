...
/**
 * Provides a mapping between the languages and the ISO 639-1 and ISO-639-2 codes.
 *
 * Taken from PEAR Text_LanguageDetect package.
 *
 * @package    Sift
 * @subpackage i18n
