...
/**
 * sfI18nChoiceFormatter class
 *
 * sfI18nChoiceFormatter converts between ranges of numeric values and string
 * names for those ranges.
 *
 * A sfI18nChoiceFormatter splits the real number line -Inf to +Inf into two or
 * more contiguous ranges. Each range is mapped to a string.
 * sfI18nChoiceFormatter is generally used in a sfI18nMessageFormat for displaying
 * grammatically correct plurals such as "There are 2 files."
 *
 * <code>
 * 	$string = '[0] are no files |[1] is one file |(1,Inf] are {number} files';
 *
 *  $formatter = new sfI18nMessageFormatter(...); //init for a source
 ...
 * are acceptable.
 *
 * Following set notation is also possible.
 *
...
class sfI18nChoiceFormatter {
  ...
  /**
   * Get instance of the choice formatter
   *
   * @return sfI18nChoiceFormatter
   */
