...
class sfI18nDateFormatter
{
    ...
    /**
     * Initializes a new sfI18nDateFormat.
     *
     * @param mixed $formatInfo either, null, a sfCulture instance, a sfI18nDateTimeFormat instance, or a locale.
     *
     * @return sfI18nDateFormat instance
     */
    public function __construct($formatInfo = null)
    {
        if (null === $formatInfo) {
            ...
            if ($formatInfo instanceof sfCulture) {
                $this->formatInfo = $formatInfo->getDateTimeFormat();
            } else {
                if ($formatInfo instanceof sfI18nDateTimeFormat) {
    ...
    public function format($time, $pattern = 'F', $inputPattern = null, $charset = 'UTF-8')
    {
        ...
        return sfI18n::i18n2Encoding(implode('', $tokens), $charset);
    }
    ...
    protected function getMon($date, $pattern = 'M')
    {
        ...
        switch ($pattern) {
            ...
            // returns stand alone month name
            case 'MMMMMM':
                return $this->formatInfo->StandAloneMonthNames[$month - 1];
            default:
