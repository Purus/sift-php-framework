 ...
 * It can cache each catalougue+variant or just the whole section.
 *
 * @package    Sift
 * @subpackage i18n
 */
class sfI18nMessageCache
{
  /**
   * Cache Lite instance.
   */
   ...
   *
   * @param string $options Options for the cache
   */  
  public function __construct($options = array())
  {
    $this->cache = new sfFileCache($options);
  }
  ...
  public function get($catalogue, $culture, $lastmodified = 0)
  {
    ...
    if ($lastmodified <= 0 || $lastmodified > $this->cache->getLastModified($ID, $group))
    {
      return false;
    }
