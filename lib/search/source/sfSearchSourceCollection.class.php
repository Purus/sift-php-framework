...
/**
 * mySearchSourceCollection - collection of sfSearchSources
 *
 * @package Sift
 * @subpackage search 
 */
class sfSearchSourceCollection implements Countable, IteratorAggregate, ArrayAccess {
   ...
   * 
   * @param array $data An array containing the records of this collection
   */
  ...
  /**
   * Set the data for the mySearchSourceCollection instance
   *
   * @param array $data
   ...
   * @return mySearchResultCollection
   */
  public function merge(sfSearchSourceCollection $coll)
  {
   ...
   * @throws Exception If key does not exist and $exception is true
   */
