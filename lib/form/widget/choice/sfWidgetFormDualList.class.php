...
class sfWidgetFormDualList extends sfWidgetFormChoice
{
    ...
    protected function configure($options = array(), $attributes = array())
    {
        ...
        $this->addOption(
            'available_button',
            sprintf(
                '<button type="button" class="btn %s-move-associated"><i class="icon-%s"></i></button>',
        ...
        $this->addOption(
            'associate_button',
            sprintf(
                '<button type="button" class="btn %s-move-available"><i class="icon-%s"></i></button>',
                $this->getOption('class'),
                $iconUnAssociated
            )
        );
...
EOF
        ...
        return $this->renderContentTag(
            ...
            strtr(
                ...
                array(
                    ...
                    '%label_filter_placeholder%' => $this->escapeOnce(
                            $this->translate($this->getOption('label_filter_placeholder'))
                        ),
    ...
    protected function renderItem($key, $item, $name, $associated = false)
    {
        ...
        return $this->renderContentTag(
            ...
            ($truncate ? sfText::truncate($value, $truncate) : $value),
            array(
