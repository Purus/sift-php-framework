...
class sfFormField
{
    ...
    public function renderRow($attributes = array(), $label = null, $help = null)
    {
        ...
        return strtr(
            $this->parent->getWidget()->getFormFormatter()->formatRow(
                $this->isLabelable() ? $this->renderLabel($label) : $this->renderLabelName(),
                $field,
                $error,
                $help,
                null,
    ...
    public function renderError($attributes = array())
    {
        ...
        $error = $this->getWidget() instanceof sfWidgetFormSchema ? $this->getWidget()->getGlobalErrors($this->error)
            : $this->error;
