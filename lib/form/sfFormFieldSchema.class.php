        ...
        if (!isset($this->fields[$name])) {
            if (null === $widget = $this->widget[$name]) {
                throw new InvalidArgumentException(sprintf(
                    'Widget "%s" does not exist in form "%s".',
                    $name,
                    get_class($this->getForm())
                ));
            }
            ...
            $this->fields[$name] = new $class($this->form, $widget, $this, $name, isset($this->value[$name])
                ? $this->value[$name] : null, $error);
        }
