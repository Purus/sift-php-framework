...
class sfFormFieldSchema extends sfFormField implements ArrayAccess, Iterator, Countable
{
   ...
   */
  public function __construct(sfForm $form, sfWidgetFormSchema $widget, sfFormField $parent = null, $name, $value, sfValidatorError $error = null)
  {
    parent::__construct($form, $widget, $parent, $name, $value, $error);
  ...
  public function offsetGet($name)
  {
    if (!isset($this->fields[$name]))
    {
      ...
      $this->fields[$name] = new $class($this->form, $widget, $this, $name, isset($this->value[$name]) ? $this->value[$name] : null, $error);
    }
