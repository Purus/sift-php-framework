...
class sfToolkit
{
                ...
                default:
                    ...
                    if (strpos($s, ',') !== false) {
                        ...
                        throw new LogicException(sprintf(
                            'Modifier exporession "%s" in "%s" not understood.',
                            $s,
                            $v[0]
                        ));
                    }
    ...
    public static function getPhpCli()
    {
        ...
        $exe_suffixes = DIRECTORY_SEPARATOR == '\\' ? (getenv('PATHEXT') ? explode(PATH_SEPARATOR, getenv('PATHEXT'))
