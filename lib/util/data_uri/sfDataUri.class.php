...
class sfDataUri {
   ...
   */
  public function __construct($mediaType = self::DEFAULT_TYPE, $data = '',
      $encoding = self::ENCODING_URL_ENCODED_OCTETS, $strict = false, $lengthMode = self::TAGLEN)
  {
   ...
   * @return sfDataUri
   */
  public function setData($data, $encoding = self::ENCODING_URL_ENCODED_OCTETS, $strict = false, $lengthMode = self::TAGLEN)
  {
