...
EOF;
  ...
  protected function build($arguments, $options)
  {
    ...
    $filesystem->copy($this->environment->get('project_root_dir').'/package.xml.tmpl',
    ...
    // replace tokens
    $filesystem->replaceTokens($this->environment->get('project_root_dir').'/package.xml', '##', '##', array(
